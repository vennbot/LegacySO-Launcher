...
class IPCBridge {
    ...
    /**
     * Tells the renderer process whether an RMS (Remesh) update is available.
     *
     * @param {boolean} needsUpdate      True if the remote version is newer.
     * @param {string|null} installedVer The version currently installed (or null).
     * @param {string} latestVer         The latest remote version.
     */
    sendRemeshShouldUpdate(needsUpdate, installedVer, latestVer) {
        try {
            this.window.webContents.send(
