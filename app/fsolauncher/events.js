...
class Events {
  ...
  listen() {
    ...
    ipcMain.on( 'SCAN_FOR_GAMES',          this.onScanForGames.bind( this ) );
  ...
  /**
   * When the user clicks the scan for games button.
   *
   * @param {Electron.IpcMainEvent} e The event object.
   */
  onScanForGames( e ) {
    this.fsolauncher.scanForExistingInstallations();
  }
